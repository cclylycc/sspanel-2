                    ...
                    <div class="box box-widget">
                        ...
                        <div class="box-footer no-padding">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <ul class="nav nav-stacked">
                                        <li>流量比例 <span class="pull-right badge bg-blue">{$node->traffic_rate}</span>
                                        </li>
                                        <li>在线人数 <span class="pull-right badge bg-aqua">{$node->getOnlineUserCount()}</span>
                                        </li>
                                        <li>产生流量 <span class="pull-right badge bg-green">{$node->getTrafficFromLogs()}</span>
                                        </li>
                                        <li>Uptime: <span class="pull-right badge bg-green">{$node->getNodeUptime()}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
