...
$app->group('/admin', function () {
    ...
    $this->get('/logout', 'App\Controllers\AdminController:logout');
  	$this->get('/kin', 'App\Controllers\AdminController:kin');

  	$this->get('/register', 'App\Controllers\Admin\RegisterController:register');
  	$this->post('/sendcode', 'App\Controllers\Admin\RegisterController:sendVerifyEmail');
   	$this->post('/register', 'App\Controllers\Admin\RegisterController:registerHandle');
})->add(new Admin());
